...
CREATE EXTERNAL TABLE IF NOT EXISTS `suan_workshop_datalake_robin_ranking_universities_db.university_ranking_csv`(
  `university` string, 
  `year` int, 
  `rank_display` string, 
  `score` float, 
...
-- Database: suan_workshop_datalake_robin_ranking_universities_db


CREATE EXTERNAL TABLE IF NOT EXISTS `suan_workshop_datalake_robin_ranking_universities_db.university_ranking_csv_all_strings`(
  `university` string, 
  `year` string, 
  `rank_display` string, 
  `score` string, 
...
CREATE OR REPLACE VIEW `suan_workshop_datalake_robin_ranking_universities_db
.university_ranking_view` AS
SELECT university,
       ...
       size, 
       faculty_count
FROM "suan_workshop_datalake_robin_ranking_universities_db
"."university_ranking_csv"
...
-- and map columns to correct data type ---
CREATE EXTERNAL TABLE IF NOT EXISTS `suan_workshop_datalake_robin_ranking_universities_db
.university_ranking`(
  `university` string, 
  `year` int, 
  `rank_display` string, 
